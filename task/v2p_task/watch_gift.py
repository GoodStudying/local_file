...
api_id = 4706648
api_hash = '05b1229064f337b71fe5a3c5b99136b5'
# cookies中间用&分开
cks = "pt_key=AAJglpmFADD8OsaJZI4BEhQ7Qn0AeQuJKrfPytwmcs5kE5JY244X0t00Q_ySSlPG5b1cwjIvWvg;pt_pin=jd_6a698329fad68"
...
# 使用代理proxy
client = TelegramClient('test', api_id, api_hash, proxy=("http", '34.92.108.9', 9101))
# 不使用代理
...
#@client.on(events.NewMessage(chats=[-1001173715142]))#自己频道
@client.on(events.NewMessage(chats=[-1001214024251]))#自己群组
